    ...
    return (
        <main className="flex justify-end">
           <section className=" w-full h-38  bg-primaryColor flex justify-between items-center p-10" >
               <section className="flex w-[73%] gap-5">
                    <section className="flex justify-center items-center w-32  h-10 gap-4 rounded-md border border-[#A0A2A3] font-inter text-white " >
                            <h1>Basic</h1>
                        <img src={downArrow} />
                    </section>
                    <section className="flex w-[100%]  h-10 border  border-[#283F43] font-inter rounded-md justify-between items-center text-white p-4 bg-[#27373A] ">
                            <CiSearch /> 
                            <input 
                                type="text"
